...
import net.engining.profile.api.param.PasswordPattern;
import net.engining.profile.api.param.SecurityControl;
import net.engining.profile.api.param.UsernamePattern;
import net.engining.profile.init.support.ParamInit;

@Service
public class SecurityControlInit implements ParamInit{
	...
	public void init() {
		...
		securityControl.complexPwdInd = false;
